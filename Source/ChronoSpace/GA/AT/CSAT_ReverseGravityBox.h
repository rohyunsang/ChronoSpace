 ...
 */
UCLASS()
class CHRONOSPACE_API UCSAT_ReverseGravityBox : public UCSAT_DurationTask
{
	GENERATED_BODY()
...
public:
	...
	static UCSAT_ReverseGravityBox* CreateTask(UGameplayAbility* OwningAbility, TSubclassOf<class ACSTA_ReverseGravityBox> InTargetActorClass);
